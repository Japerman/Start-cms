...
<head>
    <meta charset="utf-8"/>
    <title>start - simple PHP framework</title>
    <style>
...
<body>
    <div class="welcome">
        ...
        <h3>framework version: <?=START_VERSION?><br />current PHP version: <?=PHP_VERSION?></h3>
        <h4>
            <a href="https://github.com/Japerman/start">view on github</a> <span class="blank">|</span>
            <a href="https://github.com/Japerman/start#docs">documentation</a>
        </h4>
        <h5>creator, maintainer<br/> <a href="https://github.com/Japerman/" title="Jose Perez">japerman</a></h5>
    </div>
</body>
</html>
